...
File.write(File.join(base,'assets/rhythmus-2/achtel-zaehlzeiten.svg'),%(<svg xmlns="http://www.w3.org/2000/svg" width="960" height="145" viewBox="0 0 960 145" role="img" aria-labelledby="title"><title id="title">Ein 4/4-Takt mit acht Achtelnoten. Zähle: 1 &amp; 2 &amp; 3 &amp; 4 &amp;.</title>#{parts.join}</svg>))
