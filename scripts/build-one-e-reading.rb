...
(1..4).each do |exercise|
 ...
 svg=%(<svg xmlns="http://www.w3.org/2000/svg" width="960" height="145" viewBox="0 0 960 145" role="img" aria-labelledby="title"><title id="title">Leseübung #{exercise}: zwei Sechzehntel auf der ersten Hälfte von Schlag #{exercise}, Pausen auf den übrigen Schlägen</title>#{parts.join}</svg>)
