...
exercises={
 1=>{notes:{0=>4,2=>4},rests:[[1,1],[3,1]]},
 2=>{notes:{1=>4,3=>4},rests:[[0,1],[2,1]]},
 3=>{notes:{0=>4,1=>4,3=>4},rests:[[2,1]]}
}
exercises.each do |number,exercise|
 ...
 File.write(File.join(base,"assets/rhythmus-2/hoerloesung-vier-positionen-#{number}.svg"),svg)
end
