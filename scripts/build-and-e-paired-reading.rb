...
{5=>[0,2],6=>[1,3]}.each do |exercise,active_beats|
 ...
 svg=%(<svg xmlns="http://www.w3.org/2000/svg" width="960" height="145" viewBox="0 0 960 145" role="img" aria-labelledby="title"><title id="title">Leseübung #{exercise}: je zwei Sechzehntel auf der zweiten Hälfte der Schläge #{active_beats.map{|b|b+1}.join(' sowie ')}, Pausen auf den übrigen Schlägen</title>#{parts.join}</svg>)
